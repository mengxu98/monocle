...
test_that(
  "markerDiffTable works properly in vignette",
...
test_that(
  "markerDiffTable works when 'balanced set to true'",
  expect_error(markerDiffTable(HSMM[expressed_genes, ],
    cth,
    balanced = TRUE,
    residualModelFormulaStr = "~Media + num_genes_expressed",
...
test_that(
  "markerDiffTable works when 'verbose set to true'",
  expect_error(markerDiffTable(HSMM[expressed_genes, ],
    cth,
    verbose = TRUE,
    residualModelFormulaStr = "~Media + num_genes_expressed",
...
test_that(
  "markerDiffTable throws error if cds is not of type 'CellDataSet'",
...
test_that(
  ...
  expect_error(markerDiffTable(HSMM[expressed_genes, ],
    ...
    residualModelFormulaStr = "~Media + num_genes_expressed",
    cores = 1
  ), "Error cth is not of type 'CellTypeHierarchy'")
)
