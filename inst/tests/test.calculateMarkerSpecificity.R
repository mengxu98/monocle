...
test_that(
  "calculateMarkerSpecificity functions properly in vignette",
  expect_error(calculateMarkerSpecificity(HSMM[candidate_clustering_genes, ], cth), NA)
)

test_that(
  "calculateMarkerSpecificity throws error if cds is not of type CellDataSet",
  expect_error(calculateMarkerSpecificity(cth, cth), NA)
)

test_that(
  "calculateMarkerSpecificity throws error if cth is not of type CellTypeHierarchy",
